...
You are fixing a bug using the dev.sh workflow. The user has provided this bug description:
...
2. Run any relevant verification commands
3. Confirm the bug is fixed
...
- All 433+ unit tests must still pass after the fix
